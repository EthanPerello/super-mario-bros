...
function PlayState:enter(params)
    ...
    self.camX = 0
    self.camY = 0
    self.level = LevelMaker.generate(50+10*self.levelNum, 10, self.levelNum, self.score)
...
function PlayState:render()
    ...
    --render level number
    love.graphics.setColor(0, 0, 0, 1)
    love.graphics.print('Level: '..tostring(self.levelNum), 185, 5)
    love.graphics.setColor(1, 1, 1, 1)
    love.graphics.print('Level: '..tostring(self.levelNum), 184, 4)
end
